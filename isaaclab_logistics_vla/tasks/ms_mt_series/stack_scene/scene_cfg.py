...
# -----------------------------------------------------------------------
STACK_SCENE_OBJECTS = [
    'cracker_box', 'sugar_box', 'plastic_package', 'sf_small',
    'rubikscube_base0', 'rubikscube_base1', 'rubikscube_base2',
    'phone_base0', 'phone_base1', 'phone_base2', 'phone_base3', 'phone_base4',
    'remotecontrol_base0', 'remotecontrol_base1', 'remotecontrol_base2', 'remotecontrol_base3',
    'remotecontrol_base4', 'remotecontrol_base5', 'remotecontrol_base6',
...
@configclass
class Spawn_ms_mt_stack_SceneCfg(BaseOrderSceneCfg):
...
for sku_name, (usd_path, count, scale) in SKU_DEFINITIONS.items():
    for i in range(count):
        ...
        setattr(Spawn_ms_mt_stack_SceneCfg, instance_name, obj_cfg)
