...
from .Spawn_ms_mt_sparse_CommandTermCfg import Spawn_ms_mt_sparse_CommandTermCfg

ASSET_NAME = "robot"
BODY_NAME = "base_link_underpan"

@configclass
class Spawn_ms_mt_sparse_CommandsCfg:
    """Command terms for the MDP."""

    order_info = Spawn_ms_mt_sparse_CommandTermCfg(
