...
from .Spawn_ms_mt_dense_CommandTermCfg import Spawn_ms_mt_dense_CommandTermCfg
...
@configclass
class Spawn_ms_mt_dense_CommandsCfg:
    """Command terms for the MDP."""

    order_info = Spawn_ms_mt_dense_CommandTermCfg(
