...
from .command_cfg import Spawn_ss_mt_sparse_CommandsCfg
from .command_cfg import Spawn_ss_mt_sparse_with_obstacles_CommandsCfg
...
@register.add_env_configs('Spawn_ss_mt_sparse_with_obstacles_EnvCfg')
@configclass
class Spawn_ss_mt_sparse_with_obstacles_EnvCfg(ManagerBasedRLEnvCfg):

    scene: Spawn_ss_mt_sparse_SceneCfg = Spawn_ss_mt_sparse_SceneCfg(num_envs=4, env_spacing=8.0)
    observations: ObservationsCfg = ObservationsCfg()
    actions = register.load_action_configs('realman_franka_ee_actionscfg')()
    
    commands: Spawn_ss_mt_sparse_with_obstacles_CommandsCfg = Spawn_ss_mt_sparse_with_obstacles_CommandsCfg()
