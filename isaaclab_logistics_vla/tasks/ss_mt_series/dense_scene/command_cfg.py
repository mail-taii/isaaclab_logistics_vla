...
from .Spawn_ss_mt_dense_CommandTermCfg import Spawn_ss_mt_dense_CommandTermCfg
...
@configclass
class Spawn_ss_mt_dense_CommandsCfg:
    """Command terms for the MDP."""

    order_info = Spawn_ss_mt_dense_CommandTermCfg(
