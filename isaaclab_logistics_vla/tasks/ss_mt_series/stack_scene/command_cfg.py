...
from .Spawn_ss_mt_stack_CommandTermCfg import Spawn_ss_mt_stack_CommandTermCfg
...
@configclass
class Spawn_ss_mt_stack_CommandsCfg:
    """Command terms for the MDP."""

    order_info = Spawn_ss_mt_stack_CommandTermCfg(
