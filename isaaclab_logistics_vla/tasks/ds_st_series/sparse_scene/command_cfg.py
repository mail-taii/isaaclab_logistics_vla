...
from .Spawn_ds_st_sparse_CommandTermCfg import Spawn_ds_st_sparse_CommandTermCfg

ASSET_NAME = "robot"
BODY_NAME = "base_link_underpan"

@configclass
class Spawn_ds_st_sparse_CommandsCfg:
    """Command terms for the MDP."""

    order_info = Spawn_ds_st_sparse_CommandTermCfg(
