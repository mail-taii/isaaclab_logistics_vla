...
class BaseOrderSceneCfg(InteractiveSceneCfg):
    ...
    e_conveyer = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"/home/junzhe/code/isaaclab_learning/scene/G.usd",
            scale=(1, 1, 1),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
    ...
    e_desk = AssetBaseCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"/home/junzhe/code/isaaclab_learning/scene/F.usd",
            scale=(1, 1, 1),
            rigid_props=sim_utils.RigidBodyPropertiesCfg(
                rigid_body_enabled=True, 
                max_depenetration_velocity=1.0,
    ...
    s_box_1 = RigidObjectCfg(
        ...
        spawn=UsdFileCfg(
            usd_path=f"/home/junzhe/code/isaaclab_learning/scene/Box.usd",
