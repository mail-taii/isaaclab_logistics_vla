...
COFFEEBOX_BASE0 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base0.usd",
    'X_LENGTH': 0.101,
    'Y_LENGTH': 0.091,
    'Z_LENGTH': 0.13,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE1 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base1.usd",
    'X_LENGTH': 0.131,
    'Y_LENGTH': 0.121,
    'Z_LENGTH': 0.11,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE2 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base2.usd",
    'X_LENGTH': 0.131,
    'Y_LENGTH': 0.111,
    'Z_LENGTH': 0.11,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE3 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base3.usd",
    'X_LENGTH': 0.101,
    'Y_LENGTH': 0.091,
    'Z_LENGTH': 0.13,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE4 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base4.usd",
    'X_LENGTH': 0.131,
    'Y_LENGTH': 0.101,
    'Z_LENGTH': 0.12,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE5 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base5.usd",
    'X_LENGTH': 0.151,
    'Y_LENGTH': 0.031,
    'Z_LENGTH': 0.11,
    'SPARSE_ORIENT': (0, 0, 0),
...
COFFEEBOX_BASE6 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/113_coffee-box/visual/base6.usd",
    'X_LENGTH': 0.091,
    'Y_LENGTH': 0.101,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 0, 0),
...
MILKTEA_BASE0 = {
    'NAME': 'milktea_base0',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base0.usd",
    'X_LENGTH': 0.12,
    'Y_LENGTH': 0.12,
    'Z_LENGTH': 0.193,
    'SPARSE_ORIENT': (0, 180, 0),
...
MILKTEA_BASE1 = {
    'NAME': 'milktea_base1',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base1.usd",
    'X_LENGTH': 0.08,
    'Y_LENGTH': 0.08,
    'Z_LENGTH': 0.206,
    'SPARSE_ORIENT': (0, 180, 0),
...
MILKTEA_BASE2 = {
    'NAME': 'milktea_base2',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base2.usd",
    'X_LENGTH': 0.11,
    'Y_LENGTH': 0.11,
    'Z_LENGTH': 0.193,
    'SPARSE_ORIENT': (0, 180, 0),
...
MILKTEA_BASE4 = {
    'NAME': 'milktea_base4',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base4.usd",
    'X_LENGTH': 0.1,
    'Y_LENGTH': 0.1,
    'Z_LENGTH': 0.212,
    'SPARSE_ORIENT': (0, 180, 0),
...
MILKTEA_BASE5 = {
    'NAME': 'milktea_base5',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base5.usd",
    'X_LENGTH': 0.119,
    'Y_LENGTH': 0.121,
    'Z_LENGTH': 0.197,
    'SPARSE_ORIENT': (0, 180, 0),
...
MILKTEA_BASE6 = {
    'NAME': 'milktea_base6',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/101_milk-tea/visual/base6.usd",
    'X_LENGTH': 0.109,
    'Y_LENGTH': 0.109,
    'Z_LENGTH': 0.191,
    'SPARSE_ORIENT': (0, 180, 0),
...
SAUCECAN_BASE0 = {
    'NAME': 'saucecan_base0',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/105_sauce-can/visual/base0.usd",
    'X_LENGTH': 0.09,
    'Y_LENGTH': 0.09,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 180, 0),
...
SAUCECAN_BASE2 = {
    'NAME': 'saucecan_base2',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/105_sauce-can/visual/base2.usd",
    'X_LENGTH': 0.1,
    'Y_LENGTH': 0.1,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 180, 0),
...
SAUCECAN_BASE4 = {
    'NAME': 'saucecan_base4',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/105_sauce-can/visual/base4.usd",
    'X_LENGTH': 0.1,
    'Y_LENGTH': 0.1,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 180, 0),
...
SAUCECAN_BASE5 = {
    'NAME': 'saucecan_base5',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/105_sauce-can/visual/base5.usd",
    'X_LENGTH': 0.08,
    'Y_LENGTH': 0.08,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 180, 0),
...
SAUCECAN_BASE6 = {
    'NAME': 'saucecan_base6',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/105_sauce-can/visual/base6.usd",
    'X_LENGTH': 0.08,
    'Y_LENGTH': 0.08,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (0, 180, 0),
...
SMALLSPEAKER_BASE1 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/055_small-speaker/visual/base1.usd",
    'X_LENGTH': 0.07,
    'Y_LENGTH': 0.08,
    'Z_LENGTH': 0.08,
    'SPARSE_ORIENT': (0, 0, 0),
...
SMALLSPEAKER_BASE2 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/055_small-speaker/visual/base2.usd",
    'X_LENGTH': 0.112,
    'Y_LENGTH': 0.112,
    'Z_LENGTH': 0.08,
    'SPARSE_ORIENT': (0, 0, 0),
...
SMALLSPEAKER_BASE3 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/055_small-speaker/visual/base3.usd",
    'X_LENGTH': 0.128,
    'Y_LENGTH': 0.064,
    'Z_LENGTH': 0.08,
    'SPARSE_ORIENT': (0, 0, 90),
...
SOYSAUCE_BASE0 = {
    'NAME': 'soysauce_base0',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/065_soy-sauce/visual/base0.usd",
    'X_LENGTH': 0.06,
    'Y_LENGTH': 0.06,
    'Z_LENGTH': 0.255,
    'SPARSE_ORIENT': (0, 180, 90),
...
SOYSAUCE_BASE1 = {
    'NAME': 'soysauce_base1',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/065_soy-sauce/visual/base1.usd",
    'X_LENGTH': 0.09,
    'Y_LENGTH': 0.09,
    'Z_LENGTH': 0.254,
    'SPARSE_ORIENT': (0, 180, 90),
...
SOYSAUCE_BASE2 = {
    'NAME': 'soysauce_base2',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/065_soy-sauce/visual/base2.usd",
    'X_LENGTH': 0.115,
    'Y_LENGTH': 0.115,
    'Z_LENGTH': 0.254,
    'SPARSE_ORIENT': (0, 180, 90),
...
SOYSAUCE_BASE3 = {
    'NAME': 'soysauce_base3',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/065_soy-sauce/visual/base3.usd",
    'X_LENGTH': 0.09,
    'Y_LENGTH': 0.09,
    'Z_LENGTH': 0.27,
    'SPARSE_ORIENT': (0, 180, 90),
...
SOYSAUCE_BASE4 = {
    'NAME': 'soysauce_base4',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/065_soy-sauce/visual/base4.usd",
    'X_LENGTH': 0.082,
    'Y_LENGTH': 0.083,
    'Z_LENGTH': 0.153,
    'SPARSE_ORIENT': (0, 180, 90),
...
TEABOX_BASE0 = {
    'NAME': 'teabox_base0',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base0.usd",
    'X_LENGTH': 0.151,
    'Y_LENGTH': 0.101,
    'Z_LENGTH': 0.11,
    'SPARSE_ORIENT': (0, 0, 90),
...
TEABOX_BASE1 = {
    'NAME': 'teabox_base1',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base1.usd",
    'X_LENGTH': 0.151,
    'Y_LENGTH': 0.141,
    'Z_LENGTH': 0.13,
    'SPARSE_ORIENT': (0, 0, 0),
...
TEABOX_BASE2 = {
    'NAME': 'teabox_base2',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base2.usd",
    'X_LENGTH': 0.081,
    'Y_LENGTH': 0.061,
    'Z_LENGTH': 0.15,
    'SPARSE_ORIENT': (90, 90, 0),
    'STACK_ORIENT': (0, 0, 0),
    'DENSE_ORIENT': (0, 0, 0),
    'STACK_SCALE': 1,
    'SPARSE_SCALE': 0.7,
...
TEABOX_BASE3 = {
    'NAME': 'teabox_base3',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base3.usd",
    'X_LENGTH': 0.151,
    'Y_LENGTH': 0.141,
    'Z_LENGTH': 0.13,
    'SPARSE_ORIENT': (0, 0, 0),
...
TEABOX_BASE4 = {
    'NAME': 'teabox_base4',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base4.usd",
    'X_LENGTH': 0.141,
    'Y_LENGTH': 0.141,
    'Z_LENGTH': 0.11,
    'SPARSE_ORIENT': (0, 0, 0),
...
TEABOX_BASE5 = {
    'NAME': 'teabox_base5',
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/112_tea-box/visual/base5.usd",
    'X_LENGTH': 0.141,
    'Y_LENGTH': 0.141,
    'Z_LENGTH': 0.14,
    'SPARSE_ORIENT': (0, 0, 0),
...
TOOTHPASTE_BASE0 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/118_tooth-paste/visual/base0.usd",
    'X_LENGTH': 0.063,
    'Y_LENGTH': 0.031,
    'Z_LENGTH': 0.193,
    'SPARSE_ORIENT': (90, 180, 0),
    'STACK_ORIENT': (0, 0, 0),
    'DENSE_ORIENT': (0, 0, 0),
    'STACK_SCALE': 1,
    'SPARSE_SCALE': 0.9,
...
WHITEBOARD_ERASER_BASE0 = {
    ...
    'USD_PATH': f"{ASSET_ROOT_PATH}/objects_adapted/117_whiteboard-eraser/visual/base0.usd",
    'X_LENGTH': 0.114,
    'Y_LENGTH': 0.06,
    'Z_LENGTH': 0.02,
    'SPARSE_ORIENT': (0, 180, 90),
